...
/**
 * Servlet implementation class CheckSceneResult
 */
@WebServlet("/CheckSceneResult")
public class CheckSceneResult extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckSceneResult() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DatabaseAnalyzeResult dar = new DatabaseAnalyzeResult(uuid, "scene");
