...
/**
 * Servlet implementation class CheckAbResult
 */
@WebServlet("/CheckAbResult")
public class CheckAbResult extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckAbResult() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DatabaseAnalyzeResult dar = new DatabaseAnalyzeResult(uuid, "assetbundle");
